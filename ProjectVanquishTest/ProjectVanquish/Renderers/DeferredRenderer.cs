...
namespace ProjectVanquish.Renderers
{
    ...
    public class DeferredRenderer : DrawableGameComponent
    {
        ...
        private void DrawLights(GameTime gameTime, ref RenderTarget2D shadowOcclusion)
        {
            ...
            //spriteBatch.Draw((Texture2D)shadowOcclusion, new Rectangle(0, 0, 800, 600), Color.White);
            //spriteBatch.End();
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (gamePadState.Buttons.A == ButtonState.Pressed && lastGamepadState.Buttons.A == ButtonState.Released)
            {
            ...
            // Move the camera with GamePad input
            float cameraMoveAmount = 10.0f * dt;
            float cameraRotateAmount = 1.0f * dt;
            float modelRotateAmount = 1.0f * dt;
  
            camera.Position += camera.WorldMatrix.Forward * cameraMoveAmount * gamePadState.ThumbSticks.Left.Y;
            camera.Position += camera.WorldMatrix.Right * cameraMoveAmount * gamePadState.ThumbSticks.Left.X;
            ...
            {
                camera.YRotation -= cameraRotateAmount * gamePadState.ThumbSticks.Right.X;
                camera.XRotation -= cameraRotateAmount * -gamePadState.ThumbSticks.Right.Y;  
            }
