...
namespace ProjectVanquish.Renderers
{
    ...
    class CascadeShadowRenderer
    {
        ...
        /// <summary>
        /// Shadow Filtering Type - defaulted to 5x5
        /// </summary>
        ...
        /// <param name="device">The device.</param>
        /// <param name="camera">The camera.</param>
        public RenderTarget2D Draw(GraphicsDevice device, RenderTarget2D depthRT, SceneManager scene, Camera camera)
        {            
        ...
        protected void DrawShadowMap(GraphicsDevice device, SceneManager scene, int splitIndex)
        {
            ...
            // Draw the models
            scene.DrawSceneWithCustomEffect(device, shadowEffect);
        }
        ...
        protected void DrawShadowOcclusion(GraphicsDevice device, Camera camera, RenderTarget2D depthTexture)
        {
